...
//					String string = OopsUtility.readjsonFile(chooseAccount);
...
//				stockCustomer.setDate(date);
//				transaction.setDate(date);
//				transaction.setStatus("Purchase");
//				stockCustomer.setTransactions(transaction);
...
//
//				queue.enqueue(t.getDate());
//				stack.push(t.getStatus());
//			}
//		} catch (Exception e) {
...
//	}
//
//	public static void dhanush() throws IOException {
//		String string1 = OopsUtility.readjsonFile("/home/admin1/Documents/Programs/JavaPrograms/varsha.json");
//		//String string = OopsUtility.readjsonFile(StockPortfolio.str);
//		StockPortfolio.liOfStock = OopsUtility.userReadValue(string1, StockCustomer.class);
//		//for(int i=0;i<listOfStocks.size();i++) {
//		for(StockCustomer ss:listOfStocks) {
//			stack.push(ss.getStatus());
//			queue.enqueue(ss.getDate());
//
//		}
//	}
//	public static void dhanush2() {
//		for(StockCustomer ss:listOfStocks) {
//			System.out.println("status = "+stack.pop());
