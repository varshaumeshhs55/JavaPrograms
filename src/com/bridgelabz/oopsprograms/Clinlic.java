		...
		{ 
			...
			switch (choice) 
			{
				...
				case 5:
						...
						int did=OopsUtility.readInteger();
						...
						if(doc!=null)
						{
							if(doc.size()>=1)
							{
								...
								Date date=OopsUtility.printDate(OopsUtility.readString());
								if(date==null)
								{
				...
				case 7:
						...
						do
						{
							...
							case 1:
									...
									int did1=OopsUtility.readInteger();
							...
							case 2:
									...
									String dname=OopsUtility.readString();
							...
							case 3:
									...
									String avail=OopsUtility.readString();
				...
				case 8:
						...
						do
						{
							...
							case 1:
									...
									int pid1=OopsUtility.readInteger();
							...
							case 2:
									...
									String pname1=OopsUtility.readString();
							...
							case 3:
									...
									String avail1=OopsUtility.readString();
